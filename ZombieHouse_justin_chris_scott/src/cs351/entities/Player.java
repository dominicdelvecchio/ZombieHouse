  ...
  public UpdateResult update(Engine engine, double deltaSeconds)
  {
    ...
    if(stepSoundTimer > 1.0)
    {
      ...
      if(isRunning)
      {
        ...
        engine.getSoundEngine().queueSoundAtLocation("sound/footstep_walk.wav", stepLocX, stepLocY, 3.0, 1.0);
      }
      else
      {
        engine.getSoundEngine().queueSoundAtLocation("sound/footstep_walk.wav", stepLocX, stepLocY, 3.0, 0.5);
      }
